package classforjava.completed.C_1X_Mysql;
...
-----------------------------------------------------------------------------
DDL Data Definition Language(DB, 테이블-생성, 변경)
1. create table + 여러가지속성(옵션)
2. alter (수정)
3. drop(삭제)

DML Date Manipulation Language(데이터)
1. insert 테이블(속성1, 속성2, 속성3) 데이터1, 데이터2, 데이터3
2. select (조회)
3. update
4. delete    -> crud(create, read, update, delete)

DCL(권한관리)
- DCL : grant 권한부여, revoke 권한을 뺏는 것
------------------------------------------------------------------------------
